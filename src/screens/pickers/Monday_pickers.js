...
const Monday_pickers = () => {
  ...
  let sumPo = mondayArray_noDups.length;
  ...
  return (
    <>
      ...
      <div className={styles.central_po_container}>
        ...
        {mondayArray_noDups?.map((mondayArray_noDup) => (
          <TablePickers mondayArray_noDup={mondayArray_noDup} />
        ))}
      </div>
    </>
  );
